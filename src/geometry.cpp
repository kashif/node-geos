...
GEOS_UNARY_PREDICATE(IsEmpty, isEmpty, GEOSisEmpty);
GEOS_UNARY_PREDICATE(IsValid, isValid, GEOSisValid);
GEOS_UNARY_PREDICATE(IsSimple, isSimple, GEOSisSimple);
GEOS_UNARY_PREDICATE(IsRing, isRing, GEOSisRing);
GEOS_UNARY_PREDICATE(HasZ, hasZ, GEOSHasZ);
GEOS_BINARY_PREDICATE(Disjoint, disjoin, GEOSDisjoint);
GEOS_BINARY_PREDICATE(Touches, touches, GEOSTouches);
GEOS_BINARY_PREDICATE(Crosses, crosses, GEOSCrosses);
GEOS_BINARY_PREDICATE(Within, within, GEOSWithin);
GEOS_BINARY_PREDICATE(Overlaps, overlaps, GEOSOverlaps);
GEOS_BINARY_PREDICATE(Contains, contains, GEOSContains);
GEOS_BINARY_PREDICATE(Equals, equals, GEOSEquals);
GEOS_BINARY_PREDICATE_TOLERANCE(EqualsExact, equalsExact, GEOSEqualsExact);
GEOS_PREPARED_GEOM_PREDICATE(PreparedContains, preparedContains, GEOSPreparedContains);
GEOS_PREPARED_GEOM_PREDICATE(PreparedContainsProperly, preparedContainsProperly, GEOSPreparedContainsProperly);
GEOS_PREPARED_GEOM_PREDICATE(PreparedCovers, preparedCovers, GEOSPreparedCovers);
GEOS_PREPARED_GEOM_PREDICATE(PreparedIntersects, preparedIntersects, GEOSPreparedIntersects);
GEOS_UNARY_TOPOLOGY(GetEnvelope, envelope, GEOSEnvelope);
GEOS_UNARY_TOPOLOGY(GetConvexHull, convexHull, GEOSConvexHull);
GEOS_UNARY_TOPOLOGY(GetBoundary, boundary, GEOSBoundary);
GEOS_UNARY_TOPOLOGY(GetPointOnSurface, pointOnSurface, GEOSPointOnSurface);
GEOS_UNARY_TOPOLOGY(GetCentroid, centroid, GEOSGetCentroid);
GEOS_UNARY_TOPOLOGY_TOLERANCE(Simplify, simplify, GEOSSimplify);
GEOS_BINARY_TOPOLOGY(Intersection, intersection, GEOSIntersection);
GEOS_BINARY_TOPOLOGY(Difference, difference, GEOSDifference);
GEOS_BINARY_TOPOLOGY(SymDifference, symDifference, GEOSSymDifference);
GEOS_BINARY_TOPOLOGY(Union, union, GEOSUnion);
